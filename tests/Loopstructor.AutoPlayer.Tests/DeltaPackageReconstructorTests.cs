    ...
    public void Selection_UsesOnlyExactInstalledVersionAndSmallerAsset()
    {
        ...
        ResolvedDeltaPackage delta = new()
        {
            ...
            PackageAsset = new GitHubReleaseAsset
            {
                ...
                DownloadUri = new Uri("https://github.com/yingyu4451/gui2/releases/download/v0.5.3/" + deltaManifest.AssetName),
        ...
        ResolvedUpdate update = new()
        {
            ...
            PackageAsset = new GitHubReleaseAsset
            {
                ...
                DownloadUri = new Uri("https://github.com/yingyu4451/gui2/releases/download/v0.5.3/" + manifest.AssetName),
                Size = manifest.Size
            },
