...
internal static class DemoData
{
    ...
    private static JObject CheatCatalog() => new()
    {
        ...
        ["locale"] = "zh",
        ["vehicles"] = new JArray(
            CatalogItem("Shell_DoubleShell_L1", "双发重炮", "战车", 1, "Shell_DoubleShell", 0),
            CatalogItem("Shell_DoubleShell_L3", "双发重炮", "战车", 3, "Shell_DoubleShell", 0),
            CatalogItem("Link_ElectricFork_L1", "雷叉", "战车", 1, "Link_ElectricFork", 1),
            CatalogItem("Link_ElectricFork_L3", "雷叉", "战车", 3, "Link_ElectricFork", 1),
            CatalogItem("Penetrate_WindPiercer_L1", "风矢", "战车", 1, "Penetrate_WindPiercer", 2),
            CatalogItem("Penetrate_WindPiercer_L3", "风矢", "战车", 3, "Penetrate_WindPiercer", 2)),
